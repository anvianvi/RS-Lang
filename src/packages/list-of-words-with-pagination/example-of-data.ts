...
const TextBookWordsList: TextBookWord[] = [
  ...
  },
  {
    ...
    textMeaning:
      "To <i>travel</i> is to go to a faraway place on vacation or business.",
    ...
    textMeaningTranslate:
      "Путешествовать - это отправиться в далекое место на отдых или по делам",
  ...
  },
  {
    ...
    textMeaning:
      "To <i>visit</i> is to go and spend time in another place or see another person.",
